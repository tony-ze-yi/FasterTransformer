...
def validate_trt(args, config):
    ...
    with engine.create_execution_context() as context:
        ...
        context.set_binding_shape(
            0, (args.eval_batch_size, 3, args.img_size, args.img_size)
        )
        ...
        for idx, (images, target) in enumerate(epoch_iterator):
            ...
            context.execute_async_v2(
                [images_half.data_ptr()] + [d_output.data_ptr()], stream
            )
...
def parse_option():
    ...
    parser.add_argument(
        "--engine", type=str, help="The directory of vit tensorrt engine."
    )
    ...
    parser.add_argument(
        "--plugin_path",
        type=str,
        default="../../../../build/lib/libvit_plugin.so",
        help="path to plugin lib",
    )
    parser.add_argument(
        "--int8-mode",
        type=int,
